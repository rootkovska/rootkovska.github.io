...
The first one, IPFS, can (?) produce a permanent, robust, cheap, library, for every one; on top of the pre-existint "[The Internet for Everyone](http://www.ietf.org/rfc/rfc3271.txt)". The second one, Ethereum, is "how the Internet was supposed to work": contracts, procedures, accounting, currency.
...
* Multiple layered/nested encryption allows to safely share a private Ethereum project on a public huge filesystem. But it doesn't necessarily produces a safer locker; it could be all the way the opposite.
...
* And what about the buffer bloat problem? And what about garbage collection? There will be of public spiders for specific functions as well.
...
in EU are struggling to cope with that, and in many other countries as well; most of the technology enabled people of the world have learnt from us, their kids.
...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=z-0tZbLXwGI" frameborder="0" allowfullscreen>https://www.youtube.com/watch?v=z-0tZbLXwGI</iframe>
