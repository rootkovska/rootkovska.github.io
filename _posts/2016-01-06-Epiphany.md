...
Tags: [index](#index) [structure](#structure) [resources](#resources) [epifany](#epifany) [btw](#btw)
...
2. Ethereum is a very minimal contracting tool suitable for any kind of contract: from constitutions, to business, to marriages. It produces a strong registry that can be made public in parts or as a whole, evolved, and metering any information exchange from inception of the contract to the closure. And this metering is a very predictable energy function. The only connection with the steel&fire economy is electricity. No labor, no money, no other common entities: that come on top according to individual and common laws. 
...
> Se invece del vitello, te danno er mulo, tu magna e sta zitto e vaffanculo. (an old Rome's idiom, en. "If they serve you donkey meat instead of lamb, you'd better eat in silence and fuck off")
...
And the same applies to any personal device, smartphones included. Those Rooty's documents, on pair with the modern arts masterpieces (Kim.Com, Assange, Manning, Snowden), the Anonymous bitcoin developers, and the well known Ethereum developers complete the millennium job. Theoretically, at least. Shall our ancestors be proud and the future smile to you all. Thank you for all those emotions. 
