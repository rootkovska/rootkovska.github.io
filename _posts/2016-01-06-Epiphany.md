...
The same day of bartendering my driving license for the duty stamps mandatory to access the allegations pending on my head ... I've been assisted by a cute old woman that worked as document pusher between two rooms far about 25 meters from each other. One room was the documents registry, the other room was the photocopy room. The registry's young woman handles the master files to the cute old woman, she put the master files on the trailer, push the trailer to the photocopy room, and give the files to the young photocopy woman. Now, give up the detail of the young women sitting behind the glass barrier in an air conditioned environment and the old woman doing the hard job all the day long pushing the trailer up and down without pauses; that's already enough to invite the old cute woman to get a coffee with you and bomb the entire building while you are at the bar, killing everything inside the courthouse except the cute old woman, and setting her free from that burden. 
And focus on the whole thing instead: the building is nicknamed "bunker room" because it is the court where many of the big mafia trials occurs, the security measures inside there exceed the standards. There are no physical threats (theoretically). The two rooms are 20 meters distant, the maximum utp cable lenght is 90 meters. The same in the case higher standards are applied; they regard the quality of the cable changing the shielding (ie: use FTP instead of UTP cables), mandating distances from the electric cables to ensure a lesser amount of external interferences on the data cables, and so on; but the speed of the electrons is the same, so the timings of electricity on the cables is the same, so the delays between the twisted pairs inside the cables are the same, so the distances are the same. But in the bunker room of the capital city there are no cables between the registry room and the photocopy room. There is a old woman pushing a trailer for a third of 14,62 per file. Or a young woman handling a DVD for 400 euros. This was in 2010. In 2011 Berlusconi was thrown apart, Mario Monti popped up from nothing and nominated Prime Minister, then Letta and Renzi. 
In this time frame they tried to enforce new rulings to produce a administrative/civil electronic procedure that failed miserably because some law practitioners (attorneys, prosecutors, and judges) were refusing those electronic tools. We arrived (alive) in 2014: I went to my embassy in Bangkok to ask for having a certified communication with the prosecutor office in charge of my case because my lawyer disappeared and I didn't trust the one introduced by my mother, his last words: "dura lex sed lex, ignorantia legis non excusat, sorry but I don't want to go into the direction your pushing for". So I don't need him; another clone is useless. 
In dicember 2015 I acknowledge from that lawyers's union call to arms, that the government introduced videoconferencing for special cases and those fucking lawyers are complaining for it. And, as I said, they are right: the reason why I saved sub-penny after sub-penny for a few months, in order to be able to go to Bangkok from the small village I was, is that ... I was having someone recording my private talks with my mother, the new lawyer, and anyone else, about those issues and everything else; real-time monitoring: the camera driver was resetting every time I was pushing defence elements into the conversation; they were actively trying to not produce evidences in order to not let any chance for anyone to find those files in the future. All this during the Mafia Capitale scandal that those lawyers are using as an example of fair trial destruction. Result: one of the friends I've been talking with at that time was working for the head of the Rome's province police; one of the policemen arrested in that scandal. And I had also a friend here that a few decades ago have been involved (sentenced and cleared) into some kind of tax-related criminal activity. My friend in Italy was scared, my friend abroad was investigated again, I've been threatened of death (again). 

The reason for me to go searching for my closest embassy is that my embassy, in 2014, is supposed to have extraordinary communication tools, to support their legal operations, included citizens's judicial procedures. The prosecutory action is one of the two top souveregnities of any order, administration, country, nation; and they are not able to execute it. And those fucking lawyers talk about "value added" instead of asking for text files, mime encoded media content and hashes to certify and remotely confirm the genuinity of an act. The cheapest way to implement a courthouse, a paperless judicial procedure, and a remote judicial procedure. 
